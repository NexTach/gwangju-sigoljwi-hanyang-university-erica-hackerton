...
class _NotificationsScreenState extends ConsumerState<NotificationsScreen> {
  static const _notifications = [
    _NotificationItem(
      ...
      channel: ProfileNotificationChannel.report,
      id: 1,
      time: '16:03',
      title: '산책 리포트가 도착했어요',
      unread: true,
    ...
    _NotificationItem(
      ...
      channel: ProfileNotificationChannel.impact,
      id: 2,
      time: '14:21',
      title: '반룡로 구간 점수가 낮아졌어요',
      unread: true,
    ),
    _NotificationItem(
      body: '설죽로202번길 데이터가 5명 이상에게 확인되어 신뢰도 79%가 됐어요',
      channel: ProfileNotificationChannel.community,
      id: 3,
      time: '09:47',
      title: '신뢰도가 상승했어요',
      unread: false,
    ...
    final visibleNotifications = _notifications
        .where(
          (notification) =>
              ...
              preferences.allowsNotification(notification.channel!),
        )
...
class _NotificationItem {
  ...
  final String body;
  final ProfileNotificationChannel? channel;
  final int id;
  final String time;
  final String title;
  final bool unread;
