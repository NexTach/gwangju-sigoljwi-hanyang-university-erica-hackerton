              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        '서비스 안내를 위한 요약이며 정식 법률 문서가 아닙니다. '
...
const _serviceTerms = _TermsDetail(
  ...
  summary:
      ...
      '비교하고, 산책 중 감지된 도로 상태를 이웃과 함께 확인하는 서비스입니다.',
  sections: [
    _TermsSection(
      title: '수집·이용 항목',
      items: [
        '로그인 방법 선택, 닉네임, 휠체어·유모차·보행 중 선택한 이동 유형을 이용합니다. '
            '구글·카카오 버튼은 현재 실제 계정 인증을 수행하지 않습니다.',
        '경로 비교 결과, 산책 세션과 리포트, 도로 점수, 직접 작성한 커뮤니티 글·'
            '첨부 사진과 확인 반응을 서비스 화면 구성에 이용합니다.',
      ],
    ),
    _TermsSection(
      title: '이용 목적',
    ...
    _TermsSection(
      title: '보유·삭제 및 철회',
      items: [
        '닉네임과 이동 유형은 기기에 저장되며 로그아웃하면 초기화됩니다. '
            '저장한 산책 리포트는 앱 데이터 삭제 또는 앱 제거 전까지 기기에 유지되고, '
            '커뮤니티 글은 앱 실행 중에만 유지됩니다.',
...
const _privacyTerms = _TermsDetail(
  ...
  summary:
      ...
      '필요한 최소 정보만 처리합니다. 현재 간편 로그인은 외부 계정과 연결되지 않습니다.',
  sections: [
    _TermsSection(
      title: '수집·이용 항목',
      items: [
        ...
        '검증된 충격 후보가 있을 때 위치 좌표·정확도·속도와 센서 요약 특징을 처리합니다. '
            '작성한 커뮤니티 글·첨부 사진과 산책 리포트도 앱 화면에서 사용합니다.',
        '구글·카카오 계정 정보, 이메일, 전화번호, 주소록은 수집하지 않습니다. '
            '커뮤니티 첨부 사진은 앱 실행 메모리에서 상세 화면에만 표시하며 서버로 전송하지 않습니다.',
      ],
    ),
    _TermsSection(
      title: '이용 목적',
    ...
    _TermsSection(
      title: '보유·삭제 및 철회',
      items: [
        '저장한 산책 리포트는 기기에 유지됩니다. 커뮤니티 글과 첨부 사진은 앱 실행 메모리에만 '
            '있으며 앱을 다시 시작하면 초기 제공 데이터로 돌아갑니다.',
        '익명 이동 데이터 공유를 켜면 익명 세션과 충격 후보를 서버에 전송합니다. '
            '상세 기록은 기본 90일 후 삭제하고, 개인을 식별하지 않는 '
            '도로 점수·신뢰도·집계 건수만 통계로 남길 수 있습니다.',
...
const _locationTerms = _TermsDetail(
  ...
  sections: [
    ...
    _TermsSection(
      title: '처리 방식',
      items: [
        '익명 이동 데이터 공유를 켠 경우에만 충격 후보 시점의 위치와 센서 요약을 '
            '서버에 전송합니다. 원본 센서 스트림이나 전체 연속 경로는 전송하지 않습니다.',
    ...
    _TermsSection(
      title: '보유·삭제 및 철회',
      items: [
        '익명 이동 데이터 공유를 끄면 측정 결과는 기기 안에서만 사용됩니다. '
            '산책 측정을 끝내면 더 이상 센서·위치를 읽지 않습니다.',
        '서버에 전송된 상세 후보와 세션 정보는 기본 90일 보관 후 삭제하고, '
...
const _marketingTerms = _TermsDetail(
  ...
  summary:
      ...
      '동의하지 않아도 Road DNA의 기능을 이용할 수 있습니다.',
  sections: [
    _TermsSection(
      title: '수집·이용 항목',
      items: [
    ...
    _TermsSection(
      title: '보유·삭제 및 철회',
      items: [
        '현재 앱의 선택 상태는 기기에 저장되며 프로필에서 언제든 변경할 수 있습니다.',
